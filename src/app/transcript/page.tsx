...
export default function Transcript() {
    ...
    const columns: string[] = ["Nama", "NIM", "Kode MK 1", "Nama MK 1", "Nilai 1", "SKS 1", "Kode MK 2", "Nama MK 2", "Nilai 2", "SKS 2", "Kode MK 3", "Nama MK 3", "Nilai 3", "SKS 3", "Kode MK 4", "Nama MK 4", "Nilai 4", "SKS 4", "Kode MK 5", "Nama MK 5", "Nilai 5", "SKS 5", "Kode MK 6", "Nama MK 6", "Nilai 6", "SKS 6", "Kode MK 7", "Nama MK 7", "Nilai 7", "SKS 7", "Kode MK 8", "Nama MK 8", "Nilai 8", "SKS 8", "Kode MK 9", "Nama MK 9", "Nilai 9", "SKS 9", "Kode MK 10", "Nama MK 10", "Nilai 10", "SKS 10", "IPK", "Public Key", "Signature", "Unduh", "Verifikasi"];
